    ...
    <template #body>
      ...
      <div v-else class="flex flex-col gap-4">
        <div v-for="item in cart.items" :key="item.productId" class="flex gap-3 items-center">
          ...
          <div
            v-else
            class="w-16 h-16 bg-muted rounded-md flex items-center justify-center shrink-0"
          >
        ...
        <UButton label="Clear Cart" variant="outline" color="neutral" block @click="cart.clear()" />
      </div>
    </template>
  </USlideover>
</template>
