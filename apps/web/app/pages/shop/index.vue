      ...
      >
        <UCard :ui="{ body: 'p-2!' }">
          <LoadingImage
            ...
            wrapper-class="relative aspect-square w-full overflow-hidden"
            image-class="object-cover w-full h-full aspect-square transition-all duration-500 ease-in-out"
          />
